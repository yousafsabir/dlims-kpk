        ...
        <>
            ...
            <div className="flex flex-wrap justify-center px-12 py-16 gap-5">
                ...
                <div className="flex flex-col flex-1 box-shadow rounded-xl min-w-[300px] max-w-[300px] h-72 p-5 items-center text-center">
                    ...
                    <p className="text-[#0a3847] text-sm">
                        Light transport vehicle driving license is valid for
                        commercial car-taxi , jeep , Mini bus and lightweight
                        transport.
                    </p>
                </div>
                <div className="flex flex-col flex-1 box-shadow rounded-xl min-w-[300px] max-w-[300px] h-72 p-5 items-center text-center">
                    ...
                    <p className="text-[#0a3847] text-sm">
                        Heavy transport vehicle driving license is valid for
                        buses , trucks , trailers , and any type of heavy
                        transport.
                    </p>
                </div>
                <div className="flex flex-col flex-1 box-shadow rounded-xl min-w-[300px] max-w-[300px] h-72 p-5 items-center text-center">
